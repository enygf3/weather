function pageRouter() {
    ...
    function favourite() {
        ...
        appTitle.innerHTML = "Saved"

        app.appendChild(appTitle)

        //creating div for saved cities
        let appCities = document.createElement('div')
        appCities.className = "app-cities"

        app.appendChild(appCities)

        //getting all items in localstorage
        let store = {...localStorage}

        //checking each item if his value is 1
        for (let key in store) {
          ...
          //function that sets first letter to upper-case and creating for its element
        function createItem(item) {
            ...
            citiesItem.className = "cities-item"
            appCities.appendChild(citiesItem)

            let itemText = document.createElement('h3')
            itemText.innerHTML = newItem
            citiesItem.appendChild(itemText)
          }
